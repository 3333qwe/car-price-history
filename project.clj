(defproject auto "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "auto.core/on-figwheel-reload"}

                :compiler {:main auto.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/auto.js"
